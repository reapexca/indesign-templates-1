...
var Countdown = function(el, options) {
  ...
  this.getDiffDate = function() {
	...
	var diff = (this.options.date.getTime() - UTCseconds + this.options.offset) / 1000;
